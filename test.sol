...
contract P2PEnergy{
    ...
    function sellEnergy(address _prosumer,uint energyUnits) internal {
...
contract MainContract is P2PEnergy{
    ...
    function checkCurrentEnergyStatus() view public prosumerIsRegistered returns (uint energyStatus) {
